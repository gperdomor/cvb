...
<Callout type="info">
  For TypeScript users, CVB provides powerful type utilities to ensure complete type safety. See our TypeScript [guide](./typescript)
  to learn how to automatically derive prop types from your recipes.
</Callout>
